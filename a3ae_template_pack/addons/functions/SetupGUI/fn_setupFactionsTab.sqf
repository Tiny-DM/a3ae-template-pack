...
switch (_mode) do
{
    ...
    case ("factionSelected"):
    {
        ...
        private _prettyAddonHM = createHashMapFromArray [ // TODO: Do we want to trim down the dependencies list? CUP Vehicles has dependencies on CUP Units and CUP Vehicles
            ...
            ["ffaa_et_vamtac","FFAA MOD"],
            ["gsb_main", "Green Sea Battalion Gear 2019"],
            ["gsb_rhs_22_main", "Green Sea Battalion Gear 2022"],
            ["vme_pla_factions_c", "VME PLA Mod"],
            ["ASZ_Main_A3", "PedagneMod"],
            ["AFR_Insignia", "[AFR] - Arma Factions Reimagined"],
            ["Data_F_Levi", "E22 - Northstar"],
            ["Data_F_JCA_IA", "JCA - Infantry Arsenal"],
            ["Data_F_JCA_LS", "JCA - Infantry Equipment"],
            ["Data_F_RAF", "E22 - Russian Armed Forces 2.0"]
        ];
