...
allCosmeticGlasses deleteAt (allCosmeticGlasses find "OPTRE_CBRN_S");
allCosmeticGlasses deleteAt (allCosmeticGlasses find "OPTRE_CBRN_S2");
allCosmeticGlasses deleteAt (allCosmeticGlasses find "OPTRE_CBRN");
