...
["vehiclesLightUnarmed", ["OPTRE_M12_FAV", "OPTRE_M12_FAV_APC"]] call _fnc_saveToTemplate; 		//this line determines light and unarmed vehicles. -- Example: ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
...
_militiaLoadoutData set ["uniforms", ["OPTRE_DME_Temperate_Uniform"]];		//this line determines uniforms for military loadouts -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
_militiaLoadoutData set ["slUniforms", ["OPTRE_DME_Temperate_Uniform"]];
