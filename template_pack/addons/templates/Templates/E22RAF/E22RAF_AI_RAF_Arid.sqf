...
private _vehiclesLightUnarmed = ["E22_O_RAF_D_APC_Wheeled_02_unarmed_F","E22_O_RAF_D_MRAP_02_F"];
private _vehiclesLightArmed = ["E22_O_RAF_D_MRAP_02_gmg_F","E22_O_RAF_D_MRAP_02_hmg_F","E22_O_RAF_D_MRAP_02_hmg_F"];
["vehiclesTrucks", ["E22_O_RAF_D_Truck_03_covered_F","E22_O_RAF_D_Truck_03_transport_F"]] call _fnc_saveToTemplate;
["vehiclesCargoTrucks", ["E22_O_RAF_D_Truck_03_transport_F"]] call _fnc_saveToTemplate;
["vehiclesAmmoTrucks", ["E22_O_RAF_D_Truck_02_ammo_F","E22_O_RAF_D_Truck_03_ammo_F"]] call _fnc_saveToTemplate;
["vehiclesRepairTrucks", ["E22_O_RAF_D_Truck_02_box_F","E22_O_RAF_D_Truck_03_repair_F"]] call _fnc_saveToTemplate;
["vehiclesFuelTrucks", ["E22_O_RAF_D_Truck_02_fuel_F","E22_O_RAF_D_Truck_03_fuel_F"]] call _fnc_saveToTemplate;
["vehiclesMedical", ["E22_O_RAF_D_APC_Tracked_02_medical_F","E22_O_RAF_D_APC_Wheeled_02_medical_F","E22_O_RAF_D_Truck_02_medical_F","E22_O_RAF_D_Truck_03_medical_F"]] call _fnc_saveToTemplate;
["vehiclesLightAPCs", []] call _fnc_saveToTemplate;             // armed, lightly armoured, with 6-8 passengers 
["vehiclesAPCs", ["E22_O_RAF_D_APC_Wheeled_02_rcws_F"]] call _fnc_saveToTemplate;
_vehiclesIFVs = ["E22_O_RAF_D_APC_Tracked_02_cannon_AT_F"];
["vehiclesLightTanks", []] call _fnc_saveToTemplate;
["vehiclesTanks", ["E22_O_RAF_D_MBT_02_cannon_F"]] call _fnc_saveToTemplate;
private _vehiclesHeavyTanks = [];
private _vehiclesAA = ["E22_O_RAF_D_APC_Tracked_02_AA_F"];

["vehiclesTransportBoats", ["E22_O_RAF_D_Boat_Transport_02_F"]] call _fnc_saveToTemplate;
["vehiclesGunBoats", ["O_Boat_Armed_01_hmg_F"]] call _fnc_saveToTemplate;
["vehiclesAmphibious", ["E22_O_RAF_D_APC_Wheeled_02_rcws_F"]] call _fnc_saveToTemplate;

private _vehiclesPlanesCAS = ["E22_O_RAF_D_Plane_CAS_02_dynamicLoadout_F"];
private _vehiclesPlanesAA = ["E22_O_RAF_D_Plane_Fighter_02_F"];
["vehiclesPlanesTransport", []] call _fnc_saveToTemplate;
["vehiclesAirPatrol", ["E22_O_RAF_D_Heli_Light_02_unarmed_F"]] call _fnc_saveToTemplate;

["vehiclesHelisLight", ["E22_O_RAF_D_Heli_Light_02_unarmed_F"]] call _fnc_saveToTemplate;            // ideally fragile & unarmed helis seating 4+
["vehiclesHelisTransport", ["E22_O_RAF_D_Heli_Transport_04_bench_F","E22_O_RAF_D_Heli_Transport_04_covered_F"]] call _fnc_saveToTemplate;
// Should be capable of dealing damage to ground targets without additional scripting
["vehiclesHelisLightAttack", ["E22_O_RAF_D_Heli_Light_02_dynamicLoadout_F"]] call _fnc_saveToTemplate;      // Utility helis with fixed or door guns + rocket pods
private _vehiclesHelisAttack = ["E22_O_RAF_D_Heli_Attack_02_dynamicLoadout_F"];

private _vehiclesArtillery = ["E22_O_RAF_D_MBT_02_arty_F","E22_O_RAF_D_Truck_02_MRL_F"];
["magazines", createHashMapFromArray [
["E22_O_RAF_D_MBT_02_arty_F", ["32Rnd_155mm_Mo_shells_O"]],
["E22_O_RAF_D_Truck_02_MRL_F", ["12Rnd_230mm_rockets"]],
["min_rf_2b26_desert", ["40Rnd_min_rf_122mm_grad"]]
]] call _fnc_saveToTemplate; //element format: [Vehicle class, [Magazines]]

["uavsAttack", ["E22_O_RAF_D_UAV_02_dynamicLoadout_F"]] call _fnc_saveToTemplate;
private _uavsPortable = ["E22_O_RAF_D_UAV_01_F"];

//Config special vehicles
["vehiclesMilitiaLightArmed", ["E22_O_RAF_D_LSV_02_armed_F","E22_O_RAF_D_LSV_02_armed_F","E22_O_RAF_D_LSV_02_AT_F"]] call _fnc_saveToTemplate;
["vehiclesMilitiaTrucks", ["E22_O_RAF_D_Truck_02_covered_F","E22_O_RAF_D_Truck_02_transport_F"]] call _fnc_saveToTemplate;
["vehiclesMilitiaCars", ["E22_O_RAF_D_LSV_02_unarmed_F"]] call _fnc_saveToTemplate;
...
["staticMortars", ["E22_O_RAF_D_Mortar_01_F"]] call _fnc_saveToTemplate;
...
if (isClass (configFile >> "CfgVehicles" >> "min_rf_t_15")) then {
    _vehiclesLightUnarmed append ["min_rf_gaz_2330_desert", "min_rf_gaz_2330_desert", "min_rf_gaz_2330_desert"];
    _vehiclesLightArmed append ["min_rf_gaz_2330_HMG_desert", "min_rf_gaz_2330_HMG_desert", "min_min_rf_gaz_2330_HMG_desertrf_gaz_2330_HMG"];
    _vehiclesIFVs append ["min_rf_t_15_desert"];
    _vehiclesHeavyTanks = ["min_rf_t_14_desert"];
    _vehiclesAA append ["min_rf_sa_22_desert", "E22_O_RAF_D_APC_Tracked_02_AA_F"];
    _vehiclesPlanesCAS append ["min_rf_su_34"];
    _vehiclesPlanesAA append ["min_rf_su_34"];
    _vehiclesHelisAttack append ["min_rf_ka_52_grey"];
    _vehiclesArtillery append ["min_rf_2b26_desert", "E22_O_RAF_D_MBT_02_arty_F"];
...
_sfLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_arid_shortsleeve_F","E22_RAF_U_CombatUniform_01_shirt_arid_F","E22_RAF_U_CombatUniform_01_tanktop_arid_F"]];
_sfLoadoutData set ["vests", ["E22_RAF_V_CarrierRigKBT_01_tactical_arid_F","E22_RAF_V_CarrierRigKBT_01_recon_arid_F"]];
_sfLoadoutData set ["backpacks", ["E22_RAF_B_CombatPack_arid","E22_RAF_B_TacticalPack_arid"]];
_sfLoadoutData set ["helmets", ["E22_RAF_H_HelmetHBK_arid_F","E22_RAF_H_HelmetHBK_arid_F","E22_RAF_H_HelmetHBK_chops_arid_F","E22_RAF_H_HelmetHBK_ear_arid_F","E22_RAF_H_HelmetHBK_headset_arid_F"]];
_sfLoadoutData set ["facewear", ["G_Bandanna_tan","G_Bandanna_khk","G_Aviator","G_Lowprofile"]];
...
_militaryLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_arid_F","E22_RAF_U_CombatUniform_01_arid_F","E22_RAF_U_CombatUniform_01_arid_F","E22_RAF_U_CombatUniform_01_sweater_arid_F","E22_RAF_U_CombatUniform_01_arid_shortsleeve_F"]];
_militaryLoadoutData set ["vests", ["E22_RAF_V_CarrierRigKBT_01_arid_F","E22_RAF_V_CarrierRigKBT_01_light_arid_F","E22_RAF_V_CarrierRigKBT_01_heavy_arid_F","E22_RAF_V_CarrierRigKBT_01_CQB_arid_F","E22_RAF_V_CarrierRigKBT_01_command_arid_F","E22_RAF_V_CarrierRigKBT_01_combat_arid_F","E22_RAF_V_CarrierRigKBT_01_combat_arid_F","E22_RAF_V_CarrierRigKBT_01_combat_arid_F","E22_RAF_V_CarrierRigKBT_01_combat_arid_F","E22_RAF_V_CarrierRigKBT_01_combat_arid_F"]];
_militaryLoadoutData set ["backpacks", ["E22_RAF_B_Kitbag_arid","E22_RAF_B_CombatPack_arid","E22_RAF_B_Carryall_arid"]];
_militaryLoadoutData set ["helmets", ["E22_RAF_H_Helmet_Sparrow_enhanced_arid_F","E22_RAF_H_Helmet_Sparrow_headset_arid_cover_F","E22_RAF_H_Helmet_Sparrow_enhanced_arid_cover_F","E22_RAF_H_Helmet_Sparrow_standard_arid_cover_F","E22_RAF_H_Helmet_Sparrow_standard_arid_cover_F","E22_RAF_H_Helmet_Sparrow_standard_arid_cover_F"]];
...
_militiaLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_shirt_arid_F","E22_RAF_U_CombatUniform_01_shirt_arid_F","E22_RAF_U_CombatUniform_01_sweater_arid_shortsleeve_F","E22_RAF_U_CombatUniform_01_sweater_arid_F","E22_RAF_U_CombatUniform_01_arid_F"]];
_militiaLoadoutData set ["vests", ["E22_RAF_V_CarrierRigKBT_01_compact_arid_F"]];
_militiaLoadoutData set ["backpacks", ["E22_RAF_B_CombatPack_arid","E22_RAF_B_Kitbag_arid"]];
_militiaLoadoutData set ["helmets", ["E22_RAF_H_Helmet_Sparrow_headset_arid_F","E22_RAF_H_Helmet_Sparrow_standard_arid_F","E22_RAF_H_Helmet_Sparrow_standard_arid_F","E22_RAF_H_Helmet_Sparrow_standard_arid_F","E22_RAF_H_Cap_Military_arid_F","E22_RAF_H_Cap_Military_arid_F"]];
...
_crewLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_arid_shortsleeve_F"]];
_crewLoadoutData set ["vests", ["E22_RAF_V_CarrierRigKBT_01_crew_arid_F"]];
...
_officerLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_arid_F"]];
_officerLoadoutData set ["vests", ["E22_RAF_V_CarrierRigKBT_01_holster_arid_F"]];
